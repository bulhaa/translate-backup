...
/*    $scope.testValue = 0;
   setInterval(function() {
	...
	$(document).delegate('form', 'submit', function(event) {
		...
		$.post("http://192.168.1.100:8080/Translator/services/TranslatorS?wsdl/SetDefinitionO",
		{
			eText: eTextValue,
			dText: dTextValue,
			type: typeValue
	...
	$("#getRule").click(function(){
		...
		$.post("http://192.168.1.100:8080/Translator/services/TranslatorS?wsdl/setRuleO",
		{
			eText: ruleValue
		}
		,
	...
	eTextValue=$("#sent_eText").val();
		...
		$.post("http://192.168.1.100:8080/Translator/services/TranslatorS?wsdl/getDefinitionsO",
		{
			eText: eTextValue
		}
		,
